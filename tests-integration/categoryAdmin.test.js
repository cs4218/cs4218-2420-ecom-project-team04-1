...
describe('Admin Category Management API', () => {
    ...
    describe('Category Creation', () => {
        it('should create a new category successfully', async () => {
            ...
            expect(res.body.category.slug).toBe(testCategory.name.toLowerCase().replace(/\s+/g, '-'));
    ...
    describe('Category Retrieval', () => {
        ...
        it('should get a single category by slug', async () => {
            ...
            const res = await request(app).get(`/api/v1/category/single-category/${slug}`);
        ...
        it('should handle non-existent category slug', async () => {
            const res = await request(app).get('/api/v1/category/single-category/non-existent-category');
    ...
    describe('Category Update', () => {
        it('should update a category successfully', async () => {
            ...
            expect(updatedCategory.slug).toBe(updateCategory.name.toLowerCase().replace(/\s+/g, '-'));
        });
